...
if __name__ == '__main__':
  ...
  # params: --bottleneck_dir=bottlenecks --model_dir=inception --output_graph=retrained_graph.pb --output_labels=retrained_labels.txt
  #         --image_dir=images1/classifications/
